/* Nameless function Syntax: It'll not have function name instead it is assigned to a variale
 
...
 
let sum:number=0
let addition=function (...val:number[]){
...
 
let details=function (...det:(number | string)[]):number{
    return det.length
}
...
 
let opt=function (Name: string, Age: number, Dept?: string){
...
 
let calDiscount=function (price:number, discount:number=.20):void{
