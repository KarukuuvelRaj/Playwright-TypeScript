/* Lambda Syntax: It'll not have function keyword, function name and it is assigned to a variale
 
...
 
let details=(...det:(number | string)[]):number=>{
    return det.length
}
...
 
let opt=(Name: string, Age: number, Dept?: string)=>{
...
 
let calDiscount=(price:number, discount:number=.20):void=>{
